package com.example.mildangbespringstudy.member.controller;


import com.example.mildangbespringstudy.member.application.MemberService;
...
public class MemberController {
    ...
    @Operation(summary = "샘플 유저 생성 API입니다.")
